<template>
  <main class="home-page">
    ...
    <span class="material-icons">dashboard</span><span class="title">Services Conditions</span>

    <div class="dashboard">
      <div class="row">
        <div v-for="item in services_list" :key="item.id">

          <Service :name="item.name" :type="'condition'" :id="item.id" :icon_url="item.icon_url" />
