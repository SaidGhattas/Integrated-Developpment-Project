  ...
  <main class="devices-page">
    ...
    <table class="table">
      ...
      <tr v-for="item in devices_list" :key="item.device_id">
        ...
        <DeviceAction :device_id="item.device_id" :type="'actions'" :name="item.name" :ip="item.ip"
          :service_id="item.service_id" @delete-device="deleteDevice" @edit-device="editDevice" />
